          ...
          {settingsOpen && (
            <div className="absolute right-0 mt-2 w-72 bg-paper border border-line rounded-2xl shadow-2xl z-[110] p-4 animate-fade-in text-ink">
              ...
              <div className="space-y-4">
                {/* User Info */}
                <div className="bg-soft/45 p-3 rounded-xl border border-line text-xs">
                  <div className="font-bold text-ink">{currentUser.name}</div>
                  <div className="text-mut mt-0.5">{currentUser.email}</div>
                  <div className="mt-2 inline-block px-2 py-0.5 bg-sap/10 text-sap rounded-md font-extrabold text-[9px] uppercase tracking-wider">
                    {currentUser.role}
                  </div>
                </div>
