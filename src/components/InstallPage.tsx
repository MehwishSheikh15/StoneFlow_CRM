                ...
                <div key={j.id} className="bg-paper border border-line rounded-2xl p-5 shadow-sm space-y-4">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-3 text-xs py-1.5 border-b border-soft">
                      <div className={`w-4 h-4 rounded bg-em text-white flex items-center justify-center`}>
                        <Check className="w-3 h-3 stroke-[3px]" />
                      </div>
                      <span className="font-medium text-mut line-through">Unload piece & inspect site template</span>
                    </div>
                    <div className="flex items-center gap-3 text-xs py-1.5 border-b border-soft">
                      <div className={`w-4 h-4 rounded ${isOnSite ? 'bg-em text-white' : 'border border-line bg-soft'} flex items-center justify-center`}>
                        {isOnSite && <Check className="w-3 h-3 stroke-[3px]" />}
                      </div>
                      <span className={`font-medium ${isOnSite ? 'text-mut line-through' : 'text-ink'}`}>Level and fit joint adhesive</span>
                    </div>
                    <div className="flex items-center gap-3 text-xs py-1.5 border-b border-soft">
                      <div className="w-4 h-4 border border-line rounded bg-soft" />
                      <span className="font-medium text-ink">Silicone seal edges and clean marble surface</span>
                    </div>
